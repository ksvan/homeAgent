...
This SVG is hand-authored rather than Mermaid-generated so the drawing can keep
a conventional architecture layout: external interfaces at the top,
application/runtime/core layers in the middle, persistence at the bottom, and a
support/control plane on the side spanning the stack.
